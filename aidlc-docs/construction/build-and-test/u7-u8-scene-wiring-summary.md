...
### プレビュー操作修正（2026-07-30）

- 「きく・とめる・ほぞん」をスクロール領域外の下部へ固定
- 素材A/Bの変更時に自動プレビュー
- 音量・ピッチ・リバーブ・音色の変更時にライブプレビュー
- 再生中は同じクリップを先頭から再始動せず、AudioSource/EffectChain の設定だけを更新
- Create シーンの参照・固定配置検証 PASS、EditMode **97 Pass / 0 Fail**
