...
## ボタン無反応・音切れ対応（2026-07-30）

- [x] ボタン行の `childControlHeight` を無効化し、高さ0（背景消失・タップ不可）を解消する
- [x] 既存 `GeidaiCreate` の ActionRow / RecipeRow のボタン矩形を 190x70 へ復元する
- [x] スクロール下端をピクセル指定に変え、「おんしょく」まで届く表示領域を確保する
