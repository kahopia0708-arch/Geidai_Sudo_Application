...
- **Current Stage**: U3 Rec — Functional Design（Part 2 生成完了・完了ゲート／承認待ち）
...
#### U3 Rec（進行中）
- [~] Functional Design — Part2 生成完了（Q1〜Q7=全A）。domain-entities/business-logic-model/business-rules/frontend-components 作成。設計ギャップ＝IStorageService に SaveSound を U3 で追加方針（Q5=A・U4で堅牢化）。完了ゲート・承認待ち（2026-07-15）
- [ ] NFR Requirements
- [ ] NFR Design
