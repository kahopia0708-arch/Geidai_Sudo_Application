...
- [~] NFR Design — Part1 計画作成・回答待ち（2026-07-16）。U1〜U5 設計パターンを踏襲し U6 固有部品（純粋 QuestionBuilder 配置・PitchVariationService[再生時 pitch]・SoundMatchConfig[SO]・SoundMatchGameController/ChoiceItemView/FrogTargetView/ResultEffectController・素材取得 IStorageService）へ落とし込む予定。
